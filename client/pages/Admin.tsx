    ...
    <div className="container mx-auto py-10 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Full administrative access across systems, beacons, lectures, and
          members.
        </p>
      </div>
      ...
      <Tabs defaultValue="systems">
        ...
        <TabsContent value="systems">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Feature
              title="Create System"
              desc="Create a new attendance system with unique 8‑char code"
              action={<CreateSystemDialog />}
            />
            <Feature
              title="Update System"
              desc="Edit name/description and ownership"
              action={<Button variant="secondary">Edit</Button>}
            />
            <Feature
              title="Delete System"
              desc="Remove systems permanently (irreversible)"
              action={<Button variant="destructive">Delete</Button>}
            />
            <Feature
              title="Codes"
              desc="Copy/share codes with staff & students"
              action={
        ...
        <TabsContent value="beacons">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Feature
              title="Add Beacon"
              desc="Register UUID/MAC and RSSI threshold"
              action={<AddBeaconDialog />}
            />
            <Feature
              title="Discover"
              desc="Scan and monitor RSSI in real‑time"
              action={<Button variant="secondary">Scan</Button>}
            />
            <Feature
              title="Manage"
              desc="View, disable or remove beacons"
        ...
        <TabsContent value="lectures">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Feature
              ...
              desc="Title, start/end time, beacon association"
              action={<CreateLectureDialog />}
            />
            <Feature
              title="View Lectures"
              desc="Upcoming and past sessions"
              action={<Button variant="secondary">View</Button>}
            />
            <Feature
              title="Delete Lecture"
              desc="Remove with confirmation"
              action={<Button variant="destructive">Delete</Button>}
            />
          </div>
        </TabsContent>
        ...
        <TabsContent value="members">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Feature
              ...
              desc="Admins approve staff join requests"
              action={<Button>Open Queue</Button>}
            />
            <Feature
              title="Set Roles"
              desc="Promote/demote members"
              action={<Button variant="secondary">Manage Roles</Button>}
            />
            <Feature
        ...
        <TabsContent value="analytics">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Feature
              title="System Stats"
              desc="Systems, active beacons, lectures"
              action={
            ...
            <Feature
              ...
              desc="Lecture‑wise presence and images"
              action={<Button variant="secondary">Reports</Button>}
            />
          </div>
        </TabsContent>
        ...
        <TabsContent value="settings">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Feature
              ...
              desc="Compliance, CSRF, retention"
              action={
                <Button className="gap-2">
